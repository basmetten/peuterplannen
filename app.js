...
import { showCarousel, hideCarousel } from './modules/carousel.js';
    ...
    try {
        switch (s.type) {
            ...
            case 'in-sheet-detail': {
                const dh = document.getElementById('detail-sheet-host');
                if (dh?.classList.contains('open')) {
                    hideDetailInSheet();
                }
                break;
            }
